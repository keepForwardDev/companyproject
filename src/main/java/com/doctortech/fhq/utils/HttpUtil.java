...
import com.doctortech.fhq.bean.Respon;
...
public class HttpUtil {
	 ...
	 * @param tip
	 */
	public static void ajaxStatus( HttpServletResponse response, Respon respon) {
		try {
			response.setContentType("text/json");
			response.setCharacterEncoding(ENCODING);
		    PrintWriter write = response.getWriter();
		    String s = JSON.toJSON(respon).toString();
		    write.write(s);
		    write.flush();
		    write.close();
		} catch ( IOException e ) {
	 ...
	 * @return
	 */
	public static String encodeRetURL(String url,  String retUrl) {
		return encodeRetURL(url, Const.LOGIN_SUCCESS_RETURN__URL, retUrl, null);
	}
